...
--force             Include all specified files even if not recognized.
...
my ($thistype, $want_images, $want_anims, $want_force);
...
# FIXME - Diagnostics.
#print STDERR ".. File has type '$thistype'.\n";
